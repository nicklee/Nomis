...
export const datasets: Dataset[] = [
  {
    id: 'pestsyoala',
    title: 'Population estimates - local authority based by five year age band and sex',
    description: 'Annual mid-year population estimates for local authorities in the UK by five year age band and sex.',
...
export const geographyOptions: GeographyOption[] = [
  ...
  { id: 'E09000007', name: 'Camden', type: 'Local authorities (county / unitary)', category: 'current', boundaryVersion: 2023, parent: 'E12000007' },
  { id: 'E09000033', name: 'Westminster', type: 'Local authorities (county / unitary)', category: 'current', boundaryVersion: 2023, parent: 'E12000007' },
  { id: 'E09000019', name: 'Islington', type: 'Local authorities (county / unitary)', category: 'current', boundaryVersion: 2023, parent: 'E12000007' },
  { id: 'E09000012', name: 'Hackney', type: 'Local authorities (county / unitary)', category: 'current', boundaryVersion: 2023, parent: 'E12000007' },
  { id: 'E06000008', name: 'Oxford', type: 'Local authorities (county / unitary)', category: 'current', boundaryVersion: 2023, parent: 'E12000008' },
  { id: 'E06000045', name: 'Reading', type: 'Local authorities (county / unitary)', category: 'current', boundaryVersion: 2023, parent: 'E12000008' },
  { id: 'E06000023', name: 'Bristol, City of', type: 'Local authorities (county / unitary)', category: 'current', boundaryVersion: 2023, parent: 'E12000009' },
  { id: 'E08000025', name: 'Birmingham', type: 'Local authorities (county / unitary)', category: 'current', boundaryVersion: 2023, parent: 'E12000005' },
  { id: 'E08000035', name: 'Leeds', type: 'Local authorities (county / unitary)', category: 'current', boundaryVersion: 2023, parent: 'E12000003' },
  { id: 'E08000003', name: 'Manchester', type: 'Local authorities (county / unitary)', category: 'current', boundaryVersion: 2023, parent: 'E12000002' },
  ...
  { id: 'E09000007_2019', name: 'Camden (2019)', type: 'Local authorities (county / unitary)', category: 'historical', boundaryVersion: 2019, parent: 'E12000007' },
  { id: 'E09000033_2019', name: 'Westminster (2019)', type: 'Local authorities (county / unitary)', category: 'historical', boundaryVersion: 2019, parent: 'E12000007' },
  { id: 'E06000001_2011', name: 'Hartlepool (2011)', type: 'Local authorities (county / unitary)', category: 'historical', boundaryVersion: 2011, parent: 'E12000001' },
  { id: 'E06000002_2011', name: 'Middlesbrough (2011)', type: 'Local authorities (county / unitary)', category: 'historical', boundaryVersion: 2011, parent: 'E12000001' },
  { id: 'E06000048_2021', name: 'Buckinghamshire (2021)', type: 'Local authorities (county / unitary)', category: 'historical', boundaryVersion: 2021, parent: 'E12000008' },
  { id: 'E06000060_2021', name: 'North Northamptonshire (2021)', type: 'Local authorities (county / unitary)', category: 'historical', boundaryVersion: 2021, parent: 'E12000004' },
  { id: 'E06000061_2021', name: 'West Northamptonshire (2021)', type: 'Local authorities (county / unitary)', category: 'historical', boundaryVersion: 2021, parent: 'E12000004' },
  
  // Local Authority Districts (Current)
  { id: 'E07000178', name: 'Oxford District', type: 'Local authority districts (unitary / district)', category: 'current', boundaryVersion: 2023, parent: 'E06000008' }
];
